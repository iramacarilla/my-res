...
const CV = () => {
    return (
        <div className='container resume'>
            ...
            <iframe src="https://www.canva.com/design/DAFZzNUKAI8/s52xYBF1tVyXti1BO_EQYA/view?embed#view=fitH" referRerpolicy="no-referrer" allowFullScreen width="705px" height="1000px" title="Iryna Kosynienko Resumé" toolbar="0"/>
