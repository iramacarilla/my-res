    ...
    <h2 className="home-title">{text}</h2>
      <div className="home-description">
        <div className="home-description__text">
          <p className="mb-2">My name is Iryna! I'm a front-end developer with about a year of experience, a lot of professional knowledge and a passion for what I do. 
